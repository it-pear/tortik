<template>
  <div style="text-align: center;padding-top: 160px;padding-bottom: 100px">
    <svg version="1.1" id="Capa_1" fill="rgba(191, 22, 43, 1)" width="100px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <br>
    <br>
    <h1>Спасибо за заказ, в самое ближайшее время наш менеджер с вами свяжется для уточнения деталей</h1>
    <br>
    <a href="/" class="btn btn-lg btn-red tra-red-hover">Вернуться на главную</a>
  </div>
</template>
...
export default {
  layout: 'single',
  head: {
    title: `заказ | ${process.env.appName}`,
    meta: [
      {
        hid: 'description',
        name: 'description',
        content: 'Страница спасибо'
      }
    ],
  },
  head() {
